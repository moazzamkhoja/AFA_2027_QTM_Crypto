...
tokens ($t=0.32$) and $+1.01\%$ among large tokens ($t=1.67$). The token H2 null thus
survives five distinct conditioning variables --- the growth-levelized ratio, the raw
ratio, sector-demeaned valuation, turnover, and market capitalization --- and cannot be
attributed to the choice of denominator. For coins, the same exercise yields a new
