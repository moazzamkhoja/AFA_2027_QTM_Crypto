...
post-2024. Amihud illiquidity is the strongest new coin-level single (illiquid coins
...
artifact, it should revive here. It does not. Under both the practitioner fee multiple
and the revenue-DCF ratio, the interaction carries the predicted sign for the first
time --- and the split-sample slopes order correctly (cheap above expensive) --- but at
$t=-0.45$ and $t=-0.31$ it is a null, and the coverage-matched baselines show no
denominator effect to credit. The token H2 null thus survives six distinct
